...
export const AboutMe = ({ texts }: Props) => {
  return (
    ...
    >
      ...
      <h2 className="text-2xl sm:text-4xl md:text-6xl font-bold sm:leading-3 mt-2 text-center">{texts.subtitle}</h2>
      <span className="text-white opacity-30 mt-4 md:mt-8 text-center">{texts.role}</span>
